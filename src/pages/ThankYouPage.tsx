...
const ThankYouPage: React.FC = () => {
  ...
  const { order, setOrder, payment } = useOrder();
  const [isLoading, setIsLoading] = useState(false);

  async function handleRetry() {
    setIsLoading(true);
    const orderData = await orderApi.retryPayment(order?.id!, payment!);
    ...
    switch (order.status) {
      ...
      case "DECLINED":
        return {
          ...
          message:
            "Your payment was declined by your bank. Please check your payment information and try again.",
